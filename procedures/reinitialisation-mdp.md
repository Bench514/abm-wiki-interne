...
---
2. **Réinitialise-le** -> Cliquez sur le bouton/icône "réinitialiser le mot de passe"
---
...
---
6. **Nouvaux MDP** -> Entrez un nouveau mot de passe dans le champ indiqué du site web. (Mélange de lettres, de chiffres et de caractères spéciaux)
---
7. **Page de Connexion** -> Apres le reinitilization de votre mot passe, retournez à la page de connexion et entrez votre nouveau mot de passe pour accéder à votre compte.